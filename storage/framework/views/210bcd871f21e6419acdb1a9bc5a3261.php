...
<head>
    ...
    <title>SB Admin 2 - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUsers" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('admin.users.index')); ?>">List Users</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.users.create')); ?>">Add User</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.users.roles')); ?>">Manage Roles</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseProducts" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('admin.products.index')); ?>">All Products</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.products.create')); ?>">Add Product</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.products.categories')); ?>">Categories</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseReports" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('admin.reports.sales')); ?>">Sales Report</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.reports.inventory')); ?>">Inventory Report</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.reports.analytics')); ?>">Analytics</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSettings" class="collapse" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('admin.settings.profile')); ?>">My Profile</a>
                        <a class="collapse-item" href="<?php echo e(route('admin.settings.security')); ?>">Security</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown">
                                ...
                                <img class="img-profile rounded-circle" src="<?php echo e(asset('sbadmin2/img/undraw_profile.svg')); ?>">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Your Website <?php echo e(date('Y')); ?></span>
                    </div>
                </div>
            </footer>
        </div>
...
</html><?php /**PATH C:\laragon\www\web-item\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>